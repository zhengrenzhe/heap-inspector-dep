...
impl Node {
    pub fn get_node_name<'a>(&self, strings: &'a Vec<String>, strings_len: usize) -> &'a str {
    ...
    pub fn get_node_type<'a>(&self, node_types: &'a Vec<String>, node_types_len: usize) -> &'a str {
...
impl Edge {
    pub fn get_edge_name<'a>(&self, strings: &'a Vec<String>, strings_len: usize) -> &'a str {
    ...
    pub fn get_edge_type<'a>(&self, edge_types: &'a Vec<String>, edge_types_len: usize) -> &'a str {
